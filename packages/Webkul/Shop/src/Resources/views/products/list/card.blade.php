...
{{--    </div>--}}
    <!-- Card -->
{{--        </div>--}}
    <a  href="{{ url()->to('/').'/products/' . $product->url_key.'?color_id=1'}} " title="{{ $product->name }}">
        ...
        <div class="row">
        <div class="col-lg-9">
  <a class="product-name" href="{{ url()->to('/').'/products/' . $product->url_key.'?color_id=1'  }}">{{ $product->name }} </a>
        </div>
            <div class="col-lg-3">
