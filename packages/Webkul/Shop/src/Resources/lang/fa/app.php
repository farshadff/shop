...
return [
    ...
    'customer' => [
        ...
        'signup-form' => [
            ...
            'success-verify-email-unsent' => 'کد ارسالی به تلفن همراه خود را وارد کنید',
            'success-created-account' => 'حساب شما با موفقیت ساخته شد',
            ...
            'verify-sms-title' => 'کد را وارد کنید',
            'enter-mobile' => 'شماره همراه خود را وارد کنید',
            'submit' => 'ارسال'
        ],
        ...
        'login-form' => [
            ...
            'invalid-creds' => 'لطفا مشخصات خود را بررسی کنید و دوباره امتحان کنید',
    ...
    'checkout' => [
        'cart' => [
            ...
            'proceed-to-checkout' => 'ادامه فرایند خرید',
            'remove' => 'برداشتن',
            'remove-link' => 'برداشتن',
