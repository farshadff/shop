...
return [
    ...
    'users' => [
        ...
        'users' => [
            ...
            'login-error' => 'لطفا مشخصاتclass="product-grid-4" خود را بررسی کنید و دوباره امتحان کنید.',
    ...
    'cms' => [
        'pages' => [
            ...
            'channel' => 'کانال',
            'locale' => 'زبان',
            'create-btn-title' => 'ذخیره',
            'edit-title' => 'ویرایش',
            'edit-btn-title' => 'ذخیره',
            'create-success' => 'صفحه با موفقیت ساخته شد',
            'create-partial' => 'برخی صفحات درخواست داده شده موجود میباشند',
    ...
    'admin' => [
        'system' => [
            ...
            'order-number-prefix' => 'پسوند نام سفارش',
            'order-number-length' => 'طول شماره سفارش',
            'order-number-suffix' => 'پیشوند شماره سفارش',
            'default' => 'Default',
